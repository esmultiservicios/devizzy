...
var listar_contratos = function(){
	...
	var estado = $("#form_main_contrato #estado").val();	
...
function modal_contratos(){
	  $('#formContrato').attr({ 'data-form': 'save' });
	  $('#formContrato').attr({ 'action': '<?php echo SERVERURL;?>ajax/addContratosAjax.php' });
	  $('#formContrato')[0].reset();
	  $('#reg_contrato').show();
	  $('#edi_contrato').hide();
	  $('#delete_contrato').hide();
