...
function modal_categorias_contabilidad() {
    ...
    $('#ediCategoriaEgresos').hide();
    $('#deleteCategoriaEgresos').hide();
...
var listar_categoria_egresos = function() {
    var table_almacen = $("#DatatableCategoriaEgresos").DataTable({
        "destroy": true,
        "ajax": {
            "method": "POST",
    ...
    /*edit_alamcen_dataTable("#DatatableCategoriaEgresos tbody", table_almacen);
    delete_almacen_dataTable("#DatatableCategoriaEgresos tbody", table_almacen);*/
}
</script>