<?php
	...
	class cambiarContraseñaControlador extends cambiarContraseñaModelo{		
		...
		function enviarCorreo($query,$res){
			if($query){	
				...
				* {
							   ...
							   <tbody>
								  ...
								  <tr>
									<td>
										...
										<br/>Su nueva contraseña es: <b>'.$contraseña.'</b> se requiere que la cambie a la brevedad posible.
										<a href='.$url_sistema.'>Presione este enlace para acceder al Sistema FAYAD</a>
										</p>
									</td>
								   </tr>
				...
				$respuesta = cambiarContraseñaModelo::send_email_usuarios_modelo($datos_correo);
