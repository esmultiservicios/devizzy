													  ...
													  <table border="0" cellpadding="0" cellspacing="0" role="presentation" style="vertical-align:top;" width="100%">
														 <tr>
															<td align="left" style="font-size:0px;padding:15px 15px 15px 15px;word-break:break-word;">
															   <div style="font-family:Ubuntu, Helvetica, Arial;font-size:11px;line-height:1.5;text-align:left;color:#000000;">
																 <p style="text-align: justify">Estimado(a) <b>'.$colaborador.'</b>, Le damos la mas cordial bienvenida al sistema, Le notificamos lo siguiente.
															   <br/>Se ha creado su nuevo usuario de acceso el cual es <b>'.$nickname.'</b> y la contraseña asignada es: <b>'.$pass.'</b> se requiere que la cambie a la brevedad posible.<br><br>
															   <a href='.$url_sistema.'>Presione este enlace para acceder al Sistema FAYAD</a>
															   </p>
															   </div>
															</td>
