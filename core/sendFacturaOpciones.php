<?php
	...
	$result_empresa = $insMainModel->geEmpresaFacturaCorreo($usuario);	
	...
	$insMainModel->sendMail($servidor, $puerto, $contraseña, $CharSet, $SMTPSecure , $de, $para, $from, $asunto, $mensaje, $URL);
