...
<div id="page_pdf">
	<table id="factura_head">
		...
		<tr>			
            <td class="textcenter">
                        <p><b>N° Comprobante:</b> <?php echo $consulta_registro['prefijo'].''.str_pad($consulta_registro['numero_factura'], $consulta_registro['relleno'], "0", STR_PAD_LEFT);?>CBE</p>
            </td>
        </tr>
		<tr>
            <td class="textcenter">
	...
	<table id="factura_detalle">
			...
			<tfoot id="detalle_totales">				
				...
				<tr>
					<td colspan="4" class="textright"><span>Importe</span></td>
					<td class="textright"><span>L. <?php echo number_format($total,2);?></span></td>
				</tr>
				<tr>
				<td colspan="4" class="textright"><span>Descuentos y Rebajas Otorgados</span></td>
