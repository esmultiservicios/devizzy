...
?>
    <div id="page_pdf">
        <table id="factura_head">
            <tr>
                ...
                <td class="info_factura">
                    <div class="round">
                        <span class="h3">Registro de Gastos</span>
                        <p><b>N° Gasto:</b> <?php echo $consulta_registro['egresos_id']; ?></p>
                        ...
                        <p><b>Fecha Registro:</b>
                            <?php echo $consulta_registro['fecha_registro_consulta'].' '.date('g:i a',strtotime($consulta_registro['fecha_registro'])); ?>
                        </p>
                        <p><b>Categoría:</b> <?php echo $consulta_registro['categoria']; ?></p>
                    </div>
                </td>
            </tr>
        </table>
		...
		?></p>
            <p class="nota">
                <center><?php echo $insMainModel->convertir($consulta_registro["total"]).' LEMPIRAS';?></center>
            </p>
            <p class="nota"></p>
