<?php
	...
	class aperturaCajaModelo extends mainModel{
		protected function agregar_apertura_caja_modelo($datos){
			...
			$insert = "INSERT INTO apertura VALUES('$apertura_id','".$datos['colaboradores_id']."','".$datos['fecha']."','".$datos['factura_inicial']."','".$datos['factura_final']."','".$datos['monto']."','".$datos['neto']."','".$datos['estado']."','".$datos['fecha_registro']."')";
