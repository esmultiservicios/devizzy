			...
			<form class="form-inline" id="form_main_contrato">
				<div class="form-row">
					...
					<div class="form-group mx-sm-3 mb-1">
						<div class="input-group">
							<div class="input-group-append">
								...
								<select id="tipo_contrato" name="tipo_contrato" class="selectpicker" title="Tipo de Contrato" data-live-search="true">
					...
					<div class="form-group mx-sm-3 mb-1">
						<div class="input-group">
							<div class="input-group-append">
								...
								<select id="pago_planificado" name="pago_planificado" class="selectpicker" title="Pago Planificado" data-live-search="true">
									<option value="">Seleccione</option>
								</select>
							</div>	
						</div>
					...
					<div class="form-group mx-sm-3 mb-1">
						<div class="input-group">
							<div class="input-group-append">
								<span class="input-group-text"><div class="sb-nav-link-icon"></div>Tipo Empleado</span>
								<select id="tipo_empleado" name="tipo_empleado" class="selectpicker" title="Tipo Empleado" data-live-search="true">
									<option value="">Seleccione</option>
								</select>
							</div>	
						</div>
		...
		<div class="card mb-4">
			...
			<div class="card-body"> 
				<div class="table-responsive">
					<table id="dataTableContrato" class="table table-striped table-condensed table-hover" style="width:100%">
						<thead>
							<tr>
								<th>Código</th>
								<th>Empleado</th>
