                ...
                <div class="form-group mx-sm-3 mb-1">
                    <div class="input-group">
                        <div class="input-group-append">
                            ...
                            <select id="tipo_cotizacion_reporte" name="tipo_cotizacion_reporte" class="selectpicker"
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                <div class="table-responsive">
                    <table id="dataTablaReporteCotizaciones" class="table table-striped table-condensed table-hover"
                        style="width:100%">
                        <thead>
                            <tr>
                                <th>Fecha</th>
