				...
				<div class="form-row">
					<div class="col-md-12 mb-3">
						<div class="table-responsive">
							<table id="dataTableMenuAccesos" class="table table-striped table-condensed table-hover" style="width:100%">
								<thead>
									<tr>
										<th>Privilegio</th>
										<th>Menu</th>
        ...
        <div class="modal-body">
			<form class="FormularioAjax" id="formSubMenuAccesos" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="form-row">
					<div class="col-md-12 mb-3">
						<div class="table-responsive">
							<table id="dataTableSubMenuAccesos" class="table table-striped table-condensed table-hover" style="width:100%">
								<thead>
									<tr>
										<th>Privilegio</th>
										<th>Menu</th>
        ...
        <div class="modal-body">
			<form class="FormularioAjax" id="formSubMenu1Accesos" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="form-row">
					<div class="col-md-12 mb-3">
						<div class="table-responsive">
							<table id="dataTableSubMenu1Accesos" class="table table-striped table-condensed table-hover" style="width:100%">
								<thead>
									<tr>
										<th>Privilegio</th>
										<th>Menu</th>
