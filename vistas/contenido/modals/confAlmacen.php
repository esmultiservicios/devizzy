	...
	<div class="modal-dialog modal-lg modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
				...
				<div class="form-row">
					<div class="col-md-4 mb-3">
					   <label>Empresa <span class="priority">*<span/></label>
						<div class="input-group mb-3">
						  <select id="almacen_empresa_id" name="almacen_empresa_id" class="selectpicker" data-live-search="true" title="Empresa">
						  </select>
						</div>					 
					</div>				
					<div class="col-md-4 mb-3">
					...
					<div class="col-md-4 mb-3">
					  <label for="ubicacion_almacen">Ubicación <span class="priority">*<span/></label>
						<div class="input-group mb-3">
						  <select id="ubicacion_almacen" name="ubicacion_almacen" class="selectpicker" data-live-search="true" title="Ubicacion">
						  </select>
						</div>						
					</div>						
				</div>								
		...
		<div class="modal-footer">
			<button class="guardar btn btn-primary ml-2" type="submit" style="display: none;" id="reg_almacen" form="formAlmacen"><div class="sb-nav-link-icon"></div><i class="far fa-save fa-lg"></i> Registrar</button>
			<button class="editar btn btn-warning ml-2" type="submit" style="display: none;" id="edi_almacen" form="formAlmacen"><div class="sb-nav-link-icon"></div><i class="fas fa-edit fa-lg"></i> Editar</button>
			<button class="eliminar btn btn-danger ml-2" type="submit" style="display: none;" id="delete_almacen" form="formAlmacen"><div class="sb-nav-link-icon"></div><i class="fa fa-trash fa-lg"></i> Eliminar</button>				
		</div>			
      </div>
    </div>
</div>
