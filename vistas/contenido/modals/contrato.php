	...
	<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
			...
			<form class="FormularioAjax" id="formContrato" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="form-row">
					<div class="col-md-3 mb-3">
					  ...
					  <div class="input-group mb-3">
						  <select id="contrato_colaborador_id" name="contrato_colaborador_id" class="selectpicker" data-live-search="true" title="Empleado">
							<option value="">Seleccione</option>
						  </select>
					   </div>
					</div>	
					<div class="col-md-3 mb-3">
					  <label for="contrato_tipo_contrato_id">Tipo Contrato <span class="priority">*<span/></label>
					  <div class="input-group mb-3">
						  <select id="contrato_tipo_contrato_id" name="contrato_tipo_contrato_id" class="selectpicker" data-live-search="true" title="Tipo de Contrato">
							<option value="">Seleccione</option>
						  </select>
					   </div>
					</div>	
					<div class="col-md-3 mb-3">
					  <label for="contrato_pago_planificado_id">Pago Planificado <span class="priority">*<span/></label>
					  <div class="input-group mb-3">
						  <select id="contrato_pago_planificado_id" name="contrato_pago_planificado_id" class="selectpicker" data-live-search="true" title="Pago Planificado">
							<option value="">Seleccione</option>
						  </select>
					   </div>
					</div>	
					<div class="col-md-3 mb-3">
					  <label for="contrato_tipo_empleado_id">Tipo Empleado <span class="priority">*<span/></label>
					  <div class="input-group mb-3">
						  <select id="contrato_tipo_empleado_id" name="contrato_tipo_empleado_id" class="selectpicker" data-live-search="true" title="Tipo Empleado">
							<option value="">Seleccione</option>
						  </select>
					   </div>
					</div>															
						...
						<div class="input-group">
							...
							<div class="input-group-prepend">						  
								<span class="input-group-text">
									<i class="btn btn-outline-success fas fa-microphone-alt" id="search_contrato_notas_start"></i>
									<i class="btn btn-outline-success fas fa-microphone-slash" id="search_contrato_notas_stop"></i>
								</span>
							</div>								  
						</div>	
		...
		<div class="modal-footer">
			<button class="guardar btn btn-primary ml-2" type="submit" style="display: none;" id="reg_contrato" form="formContrato"><div class="sb-nav-link-icon"></div><i class="far fa-save fa-lg"></i> Registrar</button>
			<button class="editar btn btn-warning ml-2" type="submit" style="display: none;" id="edi_contrato" form="formContrato"><div class="sb-nav-link-icon"></div><i class="fas fa-edit fa-lg"></i> Editar</button>
			<button class="eliminar btn btn-danger ml-2" type="submit" style="display: none;" id="delete_contrato" form="formContrato"><div class="sb-nav-link-icon"></div><i class="fa fa-trash fa-lg"></i> Eliminar</button>					
		</div>			
      </div>
    </div>
</div>
