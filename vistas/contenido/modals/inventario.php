    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form class="FormularioAjax" id="formMovimientos" method="POST" data-form="" autocomplete="off"
                    ...
                    <div class="form-row">
                        ...
                        <div class="col-md-3 mb-3">
                            ...
                            <div class="input-group mb-3">
                                <input type="date" required id="movimiento_fecha" name="movimiento_fecha"
                    ...
                    <div class="form-row">
                        <div class="col-md-12 mb-3">
                            ...
                            <input type="text" id="movimiento_comentario" name="movimiento_comentario"
                                class="form-control">
                        </div>
                    </div>
                ...
                <div class="modal-footer">
                    <button class="guardar btn btn-primary ml-2" type="submit" style="display: none;"
                        id="modal_movimientos" form="formMovimientos">
