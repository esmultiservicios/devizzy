	...
	<div class="modal-dialog modal modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
			...
			<form class="form-horizontal FormularioAjax" id="formConfCuentasEntidades" action="" method="POST" data-form="" enctype="multipart/form-data">				
				<div class="form-row">
					<div class="col-md-12 mb-3">
						...
						<div class="input-group mb-3">
							<input type="text" required readonly id="pro_ConfCuentasEntidades" name="pro_ConfCuentasEntidades" class="form-control"/>
				...
				<div class="form-row">
					<div class="col-md-12 mb-3">
					  ...
					  <div class="input-group mb-3">
							<input type="text" required id="confEntidad" name="confEntidad" class="form-control" placeholder="Banco" class="form-control"  maxlength="30" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);"/>
							<div class="input-group-append">				
		...
		<div class="modal-footer">
			<button class="editar btn btn-warning ml-2" type="submit" style="display: none;" id="edi_confEntidades" form="formConfCuentasEntidades"><div class="sb-nav-link-icon"></div><i class="fas fa-edit fa-lg"></i> Editar</button>					
		</div>			
      </div>
    </div>
</div>
