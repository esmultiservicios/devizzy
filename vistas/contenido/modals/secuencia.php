	...
	<div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
			...
			<form class="FormularioAjax" id="formSecuencia" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="form-row">
					<div class="col-md-3 mb-3">
					    ...
					    <div class="input-group mb-3">
						  <select id="empresa_secuencia" name="empresa_secuencia" class="selectpicker" data-live-search="true" title="Empresa">
					...
					<div class="col-md-3 mb-3">
					    ...
					    <div class="input-group mb-3">
						  <select id="documento_secuencia" name="documento_secuencia" class="selectpicker" data-live-search="true" title="Documento" required>
							<option value="">Seleccione</option>
						  </select>
					    </div>					
					</div>
		...
		<div class="modal-footer">
			<button class="guardar btn btn-primary ml-2" type="submit" style="display: none;" id="reg_secuencia" form="formSecuencia"><div class="sb-nav-link-icon"></div><i class="far fa-save fa-lg"></i> Registrar</button>
			<button class="editar btn btn-warning ml-2" type="submit" style="display: none;" id="edi_secuencia" form="formSecuencia"><div class="sb-nav-link-icon"></div><i class="fas fa-edit fa-lg"></i> Editar</button>
			<button class="eliminar btn btn-danger ml-2" type="submit" style="display: none;" id="delete_secuencia" form="formSecuencia"><div class="sb-nav-link-icon"></div><i class="fa fa-trash fa-lg"></i> Eliminar</button>					
		</div>			
      </div>
    </div>
</div>
