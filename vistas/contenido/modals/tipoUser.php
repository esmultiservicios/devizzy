	...
	<div class="modal-dialog modal-md modal-dialog-centered modal-dialog-scrollable">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title">Tipo de Usuarios</h4>    
        ...
        <div class="modal-body">
			<form class="FormularioAjax" id="formTipoUsuario" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">
				...
				<div class="form-group" id="estado_tipo_usuario">				  
				  <div class="col-md-12">			
						<label class="switch">
							<input type="checkbox" id="tipo_usuario_activo" name="tipo_usuario_activo" value="1" checked>
		...
		<div class="modal-footer">
			<button class="guardar btn btn-primary ml-2" type="submit" style="display: none;" id="reg_tipo_usuario" form="formTipoUsuario"><div class="sb-nav-link-icon"></div><i class="far fa-save fa-lg"></i> Registrar</button>
			<button class="editar btn btn-warning ml-2" type="submit" style="display: none;" id="edi_tipo_usuario" form="formTipoUsuario"><div class="sb-nav-link-icon"></div><i class="fas fa-edit fa-lg"></i> Editar</button>
			<button class="eliminar btn btn-danger ml-2" type="submit" style="display: none;" id="delete_tipo_usuario" form="formTipoUsuario"><div class="sb-nav-link-icon"></div><i class="fa fa-trash fa-lg"></i> Eliminar</button>
		</div>		
      </div>
    </div>
</div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">		
			<form class="form-horizontal FormularioAjax" id="formPermisos" action="" method="POST" data-form="" enctype="multipart/form-data">				
				<div class="form-row">
					<div class="col-md-12 mb-3">
					    <input type="hidden" required="required" readonly id="permisos_tipo_user_id" name="permisos_tipo_user_id"/>
						<input type="hidden" required="required" readonly id="permisos_nombre" name="permisos_nombre"/>
						<div class="input-group mb-3">
							<input type="text" required readonly id="pro_permisos" name="pro_permisos" class="form-control"/>
							<div class="input-group-append">				
								<span class="input-group-text"><div class="sb-nav-link-icon"></div><i class="fa fa-plus-square fa-lg"></i></span>
							</div>
						</div>	 
				...
				<div class="form-group custom-control custom-checkbox custom-control-inline" id="subMenuVentas">				  
				  <div class="col-md-7">	
						<label for="opcion_guardar">Guardar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
						<label class="switch">
				...
				<div class="form-group custom-control custom-checkbox custom-control-inline" id="subMenuVentas">				  
				  <div class="col-md-7">	
						<label for="opcion_eliminar">Eliminar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
						<label class="switch">
				...
				<div class="form-group custom-control custom-checkbox custom-control-inline" id="subMenuVentas">				  
				  <div class="col-md-7">	
						<label for="opcion_imprimir">Imprimir&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
						<label class="switch">
				  ...
				  <div class="col-md-8">	
						<label for="opcion_crear">Crear&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
						<label class="switch">
				...
				<div class="form-group custom-control custom-checkbox custom-control-inline" id="subMenuVentas">				  
				  <div class="col-md-7">	
						<label for="opcion_reportes">Reportes&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
						<label class="switch">
				...
				<div class="form-group custom-control custom-checkbox custom-control-inline" id="subMenuVentas">				  
				  <div class="col-md-7">	
						<label for="opcion_view">Seleccionar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
						<label class="switch">
				  ...
				  <div class="col-md-6">	
						...
						<label class="switch" data-toggle="tooltip" data-placement="top" title="Realizar cobros y pagos">
				...
				<div class="form-group custom-control custom-checkbox custom-control-inline" id="subMenuVentas">				  
				  <div class="col-md-7">	
						<label for="opcion_cambiar">Cambiar&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</label>
						<label class="switch" data-toggle="tooltip" data-placement="top" title="Permiso que facilita al usuario cambiar su contraseña">
		...
		<div class="modal-footer">
			<button class="btn btn-primary ml-2" type="submit" id="reg_permisos" form="formPermisos"><div class="sb-nav-link-icon"></div><i class="far fa-save fa-lg"></i> Registrar</button>				
		</div>			
      </div>
    </div>
</div>
