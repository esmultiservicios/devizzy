			...
			<form class="FormularioAjax" id="formNomina" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">
				<div class="form-row">
					...
					<div class="col-md-6 mb-3">
					  ...
					  <input type="text" name="nomina_detale" id="nomina_detale" class="form-control" maxlength="100" oninput="if(this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength);">
					</div>	
					...
					<div class="col-md-3 mb-3">
					  ...
					  <div class="input-group mb-3">
						  <select id="nomina_empresa_id" name="nomina_empresa_id" class="selectpicker" data-live-search="true" title="Empresa">
						  </select>
					   </div>
					</div>																									
				</div>
			...
			<form class="FormularioAjax" id="formNominaDetalles" action="" method="POST" data-form="" autocomplete="off" enctype="multipart/form-data">				
					...
					<div class="card-body">
						<div class="form-row">				
							<div class="col-md-4 mb-3">
							  ...
							  <input type="text" id="nominad_numero" name="nominad_numero" class="form-control" placeholder="Nomina" readonly>
							</div>
				...
				<div class="card">
					...
					<div class="card-body">
						...
						<div class="form-row">				
							<div class="col-md-3 mb-3">
							  <label for="nominad_fecha_ingreso">Fecha Ingreso <span class="priority">*<span/></label>
							...
							<div class="col-md-3 mb-3">
							  <label for="nominad_fecha_ingreso">Sueldo Diario <span class="priority">*<span/></label>
							...
							<div class="col-md-3 mb-3">
							  <label for="nominad_fecha_ingreso">Sueldo por Hora <span class="priority">*<span/></label>
					...
					<div class="card-body">
						<div class="form-row">			
							<div class="col-md-3 mb-3">
							  ...
							  <input type="number" id="nominad_diast" name="nominad_diast" class="form-control" placeholder="Dias Trabajados" step="0.01" value="0.0">
							</div>
							<div class="col-md-3 mb-3">
							  <label for="nominad_retroactivo">Retroactivo</label>
							  <input type="text" id="nominad_retroactivo" name="nominad_retroactivo" class="form-control" placeholder="Rectroactivo" step="0.01" value="0.00">
							</div>
							<div class="col-md-3 mb-3">
							  <label for="nominad_bono">Bono</label>
							  <input type="text" id="nominad_bono" name="nominad_bono" class="form-control" placeholder="Bono" step="0.01" value="0.0">
							</div>	
							<div class="col-md-3 mb-3">
							  <label for="nominad_identidad">Otros Ingesos</label>
							  <input type="text" id="nominad_otros_ingresos" name="nominad_otros_ingresos" class="form-control" placeholder="Otros Ingresos" step="0.01" value="0.00">
							</div>	
						</div>
						<div class="form-row">			
							<div class="col-md-3 mb-3">
							  <label for="nominad_horas25">Horas Extras 25% <span class="priority">*<span/></label>
							  <input type="text" id="nominad_horas25" name="nominad_horas25" class="form-control" placeholder="Horas Extras 25%" step="0.01" value="0.00">
							</div>
							<div class="col-md-3 mb-3">
							  <label for="nominad_horas50">Horas Extras 50% <span class="priority">*<span/></label>
							  <input type="text" id="nominad_horas50" name="nominad_horas50" class="form-control" placeholder="Horas Extras 50%" step="0.01" value="0.00">
							</div>	
							<div class="col-md-3 mb-3">
							  <label for="nominad_horas75">Horas Extras 75% <span class="priority">*<span/></label>
							  <input type="text" id="nominad_horas75" name="nominad_horas75" class="form-control" placeholder="Horas Extras 75%" step="0.01" value="0.00">
							</div>	
							<div class="col-md-3 mb-3">
							  <label for="nominad_horas100">Horas Extras 100% <span class="priority">*<span/></label>
							  <input type="text" id="nominad_horas100" name="nominad_horas100" class="form-control" placeholder="Horas Extras 100%" step="0.01" value="0.00">
							</div>								
						</div>						
					</div>
				</div>	
					...
					<div class="card-body">
						<div class="form-row">			
							<div class="col-md-3 mb-3">
							  ...
							  <input type="number" id="nominad_deducciones" name="nominad_deducciones" class="form-control" placeholder="Deducciones" step="0.01" value="0.00">
							</div>
							<div class="col-md-3 mb-3">
							  <label for="nominad_prestamo">Prestamo</label>
							  <input type="text" id="nominad_prestamo" name="nominad_prestamo" class="form-control" placeholder="Prestamo" step="0.01" value="0.00">
							</div>
							<div class="col-md-3 mb-3">
							  <label for="nominad_ihss">IHSS</label>
							  <input type="text" id="nominad_ihss" name="nominad_ihss" class="form-control" placeholder="IHSS" step="0.01" value="0.00">
							</div>	
							<div class="col-md-3 mb-3">
							  <label for="nominad_rap">RAP</label>
							  <input type="text" id="nominad_rap" name="nominad_rap" class="form-control" placeholder="RAP" step="0.01" value="0.00">
							</div>	
						</div>	
						<div class="form-row">			
							<div class="col-md-3 mb-3">
							  <label for="nominad_isr">ISR</label>
							  <input type="number" id="nominad_isr" name="nominad_isr" class="form-control" placeholder="ISR" step="0.01" value="0.00">
							</div>
							<div class="col-md-3 mb-3">
							  <label for="nominad_incapacidad_ihss">Incapacidad IHSS</label>
							  <input type="text" id="nominad_incapacidad_ihss" name="nominad_incapacidad_ihss" class="form-control" placeholder="Incapacidad IHSS" step="0.01" value="0.00">
							</div>
						</div>	
					</div>
				</div>	
					...
					<div class="card-body">
						<div class="form-row">			
							<div class="col-md-4 mb-3">
							  ...
							  <input type="number" id="nominad_neto_ingreso" name="nominad_neto_ingreso" class="form-control" placeholder="Neto Ingresos" step="0.01" readonly>
							</div>
							<div class="col-md-4 mb-3">
							  <label for="nominad_neto_egreso">Neto Egresos</label>
							  <input type="text" id="nominad_neto_egreso" name="nominad_neto_egreso" class="form-control" placeholder="Neto Deducciones" step="0.01" readonly>
							</div>
							<div class="col-md-4 mb-3">
							  <label for="nominad_neto">Neto</label>
							  <input type="text" id="nominad_neto" name="nominad_neto" class="form-control" placeholder="Neto" step="0.01" readonly>
							</div>	
						</div>	
					</div>
				</div>					
					...
					<div class="card-body">
						<div class="form-row">			
							<div class="col-md-12 mb-3">
								...
								<div class="input-group">
									<textarea id="nomina_detalles_notas" name="nomina_detalles_notas" placeholder="Notas" class="form-control" maxlength="1000" rows="3"></textarea>	
									<div class="input-group-prepend">						  
										<span class="input-group-text">
											<i class="btn btn-outline-success fas fa-microphone-alt" id="search_nomina_detalles_notas_start"></i>
											<i class="btn btn-outline-success fas fa-microphone-slash" id="search_nomina_detalles_notas_stop"></i>
										</span>
									</div>								  
								</div>	
				...
				<div class="form-group" id="estado_nomina_detalles">				  
				  <div class="col-md-12">			
						<label class="switch">
							<input type="checkbox" id="nomina_detalles_activo" name="nomina_detalles_activo" value="1" checked>
							<div class="slider round"></div>
						</label>
			...
			<div class="form-row col-xs-12 col-sm-12 col-md-12 col-lg-12">
				<div class="col-md-3 mb-3">
					...
					<div class="input-group">
						...
						<input type="number" id="nominad_neto_ingreso1" name="nominad_neto_ingreso1" class="form-control" placeholder="Neto Ingresos" step="0.01" readonly>	
					</div> 
				</div>
				<div class="col-md-3 mb-3">
					...
					<div class="input-group">
						...
						<input type="text" id="nominad_neto_egreso1" name="nominad_neto_egreso1" class="form-control" placeholder="Neto Deducciones" step="0.01" readonly>
					</div> 
				</div>				
				<div class="col-md-3 mb-3">
					<label>Neto:</label>
					<div class="input-group mb-1">											
						...
						<input type="text" id="nominad_neto1" name="nominad_neto1" class="form-control" placeholder="Neto" step="0.01" readonly>
					</div> 
				</div>	
				<div class="col-md-3 mb-3">
					<button class="guardar btn btn-primary mt-4" type="submit" style="display: none;" id="reg_nominaD" form="formNominaDetalles"><div class="sb-nav-link-icon"></div><i class="far fa-save fa-lg"></i> Registrar</button>
					<button class="editar btn btn-warning mt-4" type="submit" style="display: none;" id="edi_nominaD" form="formNominaDetalles"><div class="sb-nav-link-icon"></div><i class="fas fa-edit fa-lg"></i> Editar</button>
					<button class="eliminar btn btn-danger mt-4" type="submit" style="display: none;" id="delete_nominaD" form="formNominaDetalles"><div class="sb-nav-link-icon"></div><i class="fa fa-trash fa-lg"></i> Eliminar</button>		
				</div> 			
			</div>
