                            ...
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                <table id="invoiceItem">
                                    <thead align="center" class="table-success">
                                        <tr>
                                            <th width="2%" scope="col"><input id="checkAll" class="formcontrol"
                                                    type="checkbox"></th>
                                                    ...
                                                    <div class="input-group-append">
                                                        <span data-toggle="tooltip" data-placement="top"
                                                            title="Búsqueda de Productos" id="icon-search-bar_0"><a
                                                                ...
                                                                class="btn btn-link form-control buscar_productos">
                                                                <div class="sb-nav-link-icon"></div><i
                        ...
                        <div class="form-group row">
                            <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                                ...
                                <button class="btn btn-secondary bill-bottom-remove" id="addDraft" type="button"
                                    ...
                                    <div class="sb-nav-link-icon"></div><i class="fas fa-file-invoice"></i> Pendientes
                                </button>
                                <button class="btn btn-secondary bill-bottom-remove" id="BillReports" type="button"
                                    ...
                                    <div class="sb-nav-link-icon"></div><i class="fas fa-file-invoice"></i> Facturas
                                </button>
                            </div>
                        </div>
                        <div class="form-group row">
