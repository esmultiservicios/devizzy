					  ...
					  <div class="form-row col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<div class="col-sm-12 col-md-12">
							...
							<div class="form-group">
								<textarea class="form-control txt" rows="6" name="notesPurchase" id="notesPurchase" placeholder="Notas" maxlength="2000"></textarea>
						  ...
						  <div class="row">					  
							...
							<div class="col-sm-9">	
								<div class="input-group">
									...
									<input value="" type="number" class="form-control" name="subTotalImportePurchase" id="subTotalImportePurchase" readonly placeholder="Importe">
								</div>
							</div>
						  </div>
						  <div class="row">
							...
							<div class="col-sm-9">
								<div class="input-group mb-1">											
									...
									<input value="" type="number" class="form-control" name="taxDescuentoPurchase" id="taxDescuentoPurchase" readonly placeholder="Descuento">
								</div>
							</div>
						  </div>
						  <div class="row">					  
