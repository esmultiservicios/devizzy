<body id="view_quote">
	<div class="container-fluid">
		<div class="card mb-4">
			...
			<div class="card-body"> 
				<form class="FormularioAjax" id="quoteForm" action="<?php echo SERVERURL;?>ajax/addCotizacionAjax.php" method="POST" data-form="save" autocomplete="off" enctype="multipart/form-data">
					...
					<div class="bill">
						...
						<div class="form-group row" style="display:none">
							...
							<div class="col-sm-5">
								<div class="input-group mb-3">
								  <input type="hidden" class="form-control" placeholder="Proceso" id="proceso_quote" name="proceso_quote" readonly>
								  <input type="hidden" class="form-control" placeholder="Cotización" id="cotizacion_id" name="cotizacion_id" readonly>
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<table id="QuoteItem">
									<thead align="center" class="table-success">
										<tr>
											<th width="2%" scope="col"><input id="checkAllQuote" class="formcontrol" type="checkbox"></th>
									...
									<tbody>
										<tr>
											...
											<td>
												<input type="hidden" name="referenciaProductoQuote[]" id="referenciaProductoQuote_0" class="form-control inputfield-details1" placeholder="Referencia Producto Precio" autocomplete="off">
												<input type="hidden" name="isvQuote[]" id="isvQuote_0" class="form-control inputfield-details1" placeholder="Producto ISV" autocomplete="off">
												<input type="hidden" name="valorQuote_isv[]" id="valorQuote_isv_0" class="form-control inputfield-details1" placeholder="Valor ISV" autocomplete="off">
												<input type="hidden" name="productosQuote_id[]" id="productosQuote_id_0" class="form-control inputfield-details1" placeholder="Código del Producto" autocomplete="off">
												<div class="input-group mb-3">
													 <div class="input-group-append">				
														<span data-toggle="tooltip" data-placement="top" title="Búsqueda de Productos" id="icon-search-bar_0"><a data-toggle="modal" href="#" class="btn btn-link form-control buscar_productos_quote"><div class="sb-nav-link-icon"></div><i class="fas fa-search fa-lg icon-color"></i></a></span>
											...
											<td>
												<input type="text" name="productNameQuote[]" id="productNameQuote_0" placeholder="Descripción del Producto" readonly class="form-control inputfield-details1" autocomplete="off">								
											</td>
											<td>
												<input type="number" name="quantityQuote[]" id="quantityQuote_0" placeholder="Cantidad" class="buscar_cantidad form-control inputfield-details" autocomplete="off" step="0.01">
												<input type="hidden" name="cantidad_mayoreoQuote[]" id="cantidad_mayoreoQuote_0" placeholder="Cantidad Mayoreo" class="buscar_cantidad form-control inputfield-details" autocomplete="off" step="0.01">
												</td>
											<td>
						...
						<div class="form-group row">
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
								<button class="btn btn-secondary ml-3 bill-bottom-add" id="addRowsQuote" type="button" data-toggle="tooltip" data-placement="top" title="Agregar filas en la factura"><div class="sb-nav-link-icon"></div><i class="fas fa-plus"></i> Agregar</button>
								<button class="btn btn-secondary delete bill-bottom-remove" id="removeRowsQuote" type="button" data-toggle="tooltip" data-placement="top" title="Remover filas en la factura"><div class="sb-nav-link-icon"></div><i class="fas fa-minus"></i> Quitar</button>						
							</div>
						</div>
						<div class="form-group row">
						  <div class="form-row col-xs-12 col-sm-12 col-md-12 col-lg-12">
							<div class="col-sm-12 col-md-12">
								...
								<div class="form-group">
									<textarea class="form-control txt" rows="5" name="notesQuote" id="notesQuote" placeholder="Notas" maxlength="2000"></textarea>
								...
								<div class="card-body">
									<div class="form-group mx-sm-3 mb-1">
										<div class="input-group">				
											<div class="input-group-append">				
												<span class="input-group-text"><div class="sb-nav-link-icon"></div>Vigencia Cotización</span>
											</div>
											<select id="vigencia_quote" name="vigencia_quote" class="custom-select" data-toggle="tooltip" data-placement="top" title="Vigencia Cotización">
							...
							<div class="col-xs-12 col-sm-12 col-md-12 col-lg-4" style="display: none;">
							  <div class="row">					  
								<div class="col-sm-3 form-inline">
								  <label data-toggle="tooltip" data-placement="top" title="Valor antes del Descuento">Importe:</label>
								</div>
								<div class="col-sm-9">	
									<div class="input-group">
										...
										<input value="" type="number" class="form-control" name="subTotalImporteQuote" id="subTotalImporteQuote" readonly placeholder="Importe ">
									</div>
								</div>
							  </div>	
							  <div class="row">
								...
								<div class="col-sm-9">
									<div class="input-group mb-1">											
										...
										<input value="" type="number" class="form-control" name="taxDescuentoQuote" id="taxDescuentoQuote" readonly placeholder="Descuento">
									</div>
								</div>
							  </div>				
							  <div class="row">					  
								...
								<div class="col-sm-9">	
									<div class="input-group">
										...
										<input value="" type="number" class="form-control" name="subTotalQuote" id="subTotalQuote" readonly placeholder="Subtotal">
									</div>
								</div>
							  </div>
							  <div class="row">
								...
								<div class="col-sm-9">
									<div class="input-group mb-1">											
										...
										<input value="" type="number" class="form-control" name="taxAmountQuote" id="taxAmountQuote" readonly placeholder="Impuesto">
									</div>
								</div>
							  </div>						  
							  <div class="row">
								...
								<div class="col-sm-9">
									<div class="input-group mb-1">
										...
										<input value="" type="number" class="form-control" name="totalAftertaxQuote" id="totalAftertaxQuote" readonly placeholder="Total">
									</div>
								</div>
							  </div>
							</div>
