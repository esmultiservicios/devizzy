        ...
        <div class="card-body">
			<form class="form-inline" id="form_main_pagar_proveedores">
					<div class="form-group mx-sm-3 mb-1">
						<div class="input-group">
							<div class="input-group-append">
								...
								<select id="pagar_proveedores_estado" name="pagar_proveedores_estado" class="selectpicker" title="Estado" data-live-search="true">
					...
					<div class="form-group mx-sm-3 mb-1">
						<div class="input-group">
							<div class="input-group-append">
								<span class="input-group-text"><div class="sb-nav-link-icon"></div>Proveedores</span>
								<select id="pagar_proveedores" name="pagar_proveedores" class="selectpicker" title="Proveedores" data-live-search="true">
					...
					<div class="form-group mx-sm-3 mb-1">
						<div class="input-group">				
							...
							<input type="date" required id="fechai" name="fechai" value="<?php echo date ("Y-m-d");?>" class="form-control" data-toggle="tooltip" data-placement="top" title="Fecha Fin">
						</div>
				  </div>	
				  <div class="form-group mx-sm-3 mb-1">
				 	<div class="input-group">				
