<div class="container-fluid">
    <ol class="breadcrumb mt-2 mb-4">
        ...
        <li class="breadcrumb-item active">Configuración de Cuenta</li>
    </ol>
    <div class="card mb-4">
		<div class="card mb-4">
			...
			<div class="card-body"> 
				<div class="table-responsive">
					<table id="dataTableConfDiarios" class="table table-striped table-condensed table-hover" style="width:100%">
						<thead>
							<tr>
								<th>Entidad</th>
								<th>Cuenta</th>							
