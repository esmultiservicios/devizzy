...
<div id="nomina_detalles" style="display: none;">	
	<div class="container-fluid">
		<ol class="breadcrumb mt-2 mb-4">
			<li class="breadcrumb-item"><a class="breadcrumb-link" href="<?php echo SERVERURL; ?>dashboard/">Dashboard</a></li>
			<li class="breadcrumb-item active"><a class="breadcrumb-link" id="volver_nomina" href="<?php echo SERVERURL; ?>dashboard/">Nomina</a></li>
			...
			<div class="card-body">
				<form class="form-inline" id="form_main_nominas_detalles">	
					...
					<div class="form-group mx-sm-3 mb-1">
						<div class="input-group">
							<div class="input-group-append">
								<span class="input-group-text"><div class="sb-nav-link-icon"></div>Empleado</span>
								<select id="detalle_nomina_empleado" name="detalle_nomina_empleado" class="selectpicker" title="Empleado" data-live-search="true">
									<option value="">Seleccione</option>
								 </select>
							</div>	
						</div>
		...
		<div class="card mb-4">
			<div class="card mb-4">
				...
				<div class="card-body"> 
					<div class="table-responsive">
						<table id="dataTableNominaDetalles" class="table table-striped table-condensed table-hover" style="width:100%">
							<thead>
								<tr>
									<th>Nomina</th>
									<th>Contrato</th>
