    ...
    <button class="btn btn-link btn-sm order-1 order-lg-0" id="sidebarToggle" href="#"><i class="fas fa-bars fa-lg"></i></button>
        ...
        <div class="dropdown d-block d-sm-block d-md-none">
            ...
            <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                 ...
                 <a class="dropdown-item reporteVentas" href="<?php echo SERVERURL; ?>reporteVentas/" style="display:none"><div class="sb-nav-link-icon"></i></div>Reporte Ventas</a>
                 <a class="dropdown-item reporteCotizacion" href="<?php echo SERVERURL; ?>reporteCotizacion/" style="display:none"><div class="sb-nav-link-icon"></div>Reporte Cotización</a>
                 <a class="dropdown-item reporteCompras" href="<?php echo SERVERURL; ?>reporteCompras/" style="display:none"><div class="sb-nav-link-icon"></div>Reporte Compras</a>
                <a class="dropdown-item cobrarClientes" href="<?php echo SERVERURL; ?>cobrarClientes/" style="display:none"><div class="sb-nav-link-icon"></div>CXC Clientes</a>
                <a class="dropdown-item pagarProveedores" href="<?php echo SERVERURL; ?>pagarProveedores/" style="display:none"><div class="sb-nav-link-icon"></div>CXP Proveedores</a>						
