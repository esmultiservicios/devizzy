...
<script src="<?php echo SERVERURL; ?>ajax/charts/Chart.min.js" crossorigin="anonymous"></script>
<script src="<?php echo SERVERURL; ?>ajax/charts/chartjs-plugin-datalabels@2.0.0.js"></script>
<script src="<?php echo SERVERURL; ?>ajax/js/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="<?php echo SERVERURL; ?>ajax/js/menu-despelgable.js"></script>
