        ...
        <div class="nav">
            ...
            <div class="collapse" id="collapseVentas" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>clientes/" id="clientes"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-user"></i></div>Clientes
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>facturas/" id="facturas"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-file-invoice"></i></div>Facturas
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>cotizacion/" id="cotizacion"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-file-invoice-dollar"></i></div>Cotización
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>cajas/" id="cajas" style="display:none">
            ...
            <div class="collapse" id="collapseCompras" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>proveedores/" id="proveedores"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-user-tie"></i></div>Proveedores
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>facturaCompras/" id="facturaCompras"
                        style="display:none">
            ...
            <div class="collapse" id="collapseAlmacen" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>productos/" id="productos"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fab fa-product-hunt"></i></div>Productos
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>inventario/" id="inventario"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fab fa-servicestack"></i></div>Movimientos
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>transferencia/" id="transferencia"
                        style="display:none">
            ...
            <div class="collapse" id="collapseReportes" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav accordion" id="sidenavAccordionPages">
                    ...
                    <div class="collapse" id="historialCollapse" aria-labelledby="headingOne"
                        ...
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link link" href="<?php echo SERVERURL; ?>historialAccesos/"
                                id="historialAccesos" style="display:none">
                                <div class="sb-nav-link-icon"><i class="fas fa-history"></i></div>Accesos
                            </a>
                            <a class="nav-link link" href="<?php echo SERVERURL; ?>bitacora/" id="bitacora"
                                style="display:none">
                    ...
                    <div class="collapse" id="facturasCollapse" aria-labelledby="headingOne"
                        data-parent="#sidenavAccordionPages">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link link" href="<?php echo SERVERURL; ?>reporteVentas/" id="reporteVentas"
                                style="display:none">
                                <div class="sb-nav-link-icon"><i class="fab fa-sellsy"></i></div>Ventas
                            </a>
                            <a class="nav-link link" href="<?php echo SERVERURL; ?>reporteCotizacion/"
                                id="reporteCotizacion" style="display:none">
                                <div class="sb-nav-link-icon"><i class="fas fa-file-invoice-dollar"></i></div>Cotización
                            </a>
                            <a class="nav-link link" href="<?php echo SERVERURL; ?>cobrarClientes/" id="cobrarClientes"
                                style="display:none">
                    ...
                    <div class="collapse" id="comprasCollapse" aria-labelledby="headingOne"
                        data-parent="#sidenavAccordionPages">
                        <nav class="sb-sidenav-menu-nested nav">
                            <a class="nav-link link" href="<?php echo SERVERURL; ?>reporteCompras/" id="reporteCompras"
                                style="display:none">
                                <div class="sb-nav-link-icon"><i class="fas fa-file-invoice-dollar"></i></div>Compras
                            </a>
                            <a class="nav-link link" href="<?php echo SERVERURL; ?>pagarProveedores/"
            ...
            <div class="collapse" id="recursosHumanos" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>colaboradores/" id="colaboradores"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-user-plus"></i></div>Colaboradores
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>contrato/" id="contrato"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-file-signature"></i></div>Contrato
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>nomina/" id="nomina" style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-hand-holding-usd"></i></div>Nomina
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>asistencia/" id="asistencia"
                        style="display:none">
            ...
            <div class="collapse" id="configuracion" aria-labelledby="headingOne" data-parent="#sidenavAccordion">
                <nav class="sb-sidenav-menu-nested nav">
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>puestos/" id="puestos" style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-briefcase"></i></div>Puestos
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>users/" id="users" style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-user-cog"></i></div>Usuarios
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>secuencia/" id="secuencia"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-sliders-h"></i></div>Secuencia
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>empresa/" id="empresa" style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-building"></i></div>Empresa
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confAlmacen/" id="confAlmacen"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fab fas fa-warehouse"></i></div>Almacén
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confImpresora/" id="confImpresora"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fab fas fa-print"></i></div>Impresora
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confUbicacion/" id="confUbicacion"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-search-location"></i></div>Ubicación
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confCategoria/" id="confCategoria"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fas fa-layer-group"></i></div>Categoría
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confMedida/" id="confMedida"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-balance-scale-left"></i></div>Medidas
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confPlanes/" id="confPlanes"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-globe"></i></div>Planes
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confHost/" id="confHost"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-network-wired"></i></div>Hosts
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confHostProductos/" id="confHostProductos"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-network-wired"></i></div>Productos Hosts
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>confEmail/" id="confEmail"
                        style="display:none">
                        <div class="sb-nav-link-icon"><i class="fas fa-envelope"></i></div>Correo
                    </a>
                    <a class="nav-link link" href="<?php echo SERVERURL; ?>privilegio/" id="privilegio"
                        style="display:none">
